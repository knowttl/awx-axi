...
- Current v1 command coverage is the eight domains in `src/domains/` and their `DOMAINS` registration in `src/cli.ts`, including inventories and related resources.
