...
- Current v1 command coverage is all eleven registered `DOMAINS` in `src/cli.ts`: `job`, `template`, `workflow`, `organization`, `credential`, `approval`, `ad-hoc`, `project`, `inventory`, `schedule`, `execution-environment`, `user`.
