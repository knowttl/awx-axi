...
- Current v1 command coverage is the six domains in `src/domains/` and their `DOMAINS` registration in `src/cli.ts`, and this includes inventories and related resources.
