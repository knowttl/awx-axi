...
export const SKILL_DESCRIPTION =
  "Manage AWX 24.6.1 automation from the shell - inspect, create, edit, copy, delete, launch, cancel, associate, and configure controller resources with dry-run previews and gated writes. Use for AWX or Ansible Tower jobs, templates, workflows, inventories, projects, schedules, organizations, credentials, notifications, execution environments, teams, users, roles, and maintenance runs.";
...
\`workflow\`: create, edit, delete, list, show, survey, launch, nodes, node-create/edit/delete/link/unlink, node-add-approval, node credential/label/instance-group add/remove, notification-add/remove.
...
\`organization\`: create, edit, delete, team-add/remove, execution-environment-add/remove, galaxy-credential-add/remove, notification-template-add/remove, notification-add/remove, list, show.
\`credential\`: create, edit, copy, delete, list, show.
\`user\`: create, edit, delete, token-create, token-revoke, list, show.
\`team\`: create, edit, delete, credential-create, list, show, users, projects, credentials, roles, object-roles, access-list.
...
Read-only generated commands: notification list, show <id>; notification-template list, show <id|name>; activity-stream list, show <id>.
