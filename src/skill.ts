...
export const SKILL_DESCRIPTION =
  "Inspect and run AWX automation from the shell - jobs, job templates, workflows, approvals, and projects. Use whenever a task involves AWX or Ansible Tower automation: checking running jobs, launching templates, approving workflow nodes, or inspecting automation projects.";
